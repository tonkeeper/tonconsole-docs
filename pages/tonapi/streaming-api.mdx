...
Then it starts streaming transactions that belong to the given list of accounts.
...
`subscribe_account` takes in a list of string items as "params" argument and starts streaming transactions.
