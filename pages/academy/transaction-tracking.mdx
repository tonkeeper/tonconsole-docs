...
{/* Alright, let’s break down how the hell you’re supposed to track a transaction in TON. If you’ve ever used Ethereum or Bitcoin, you might think: "Yeah, I just grab the hash of the transaction and I’m good." Well, surprise – TON doesn’t work that way. Not even close. */}
...
**Trace** – It’s a tree. Nodes = transactions. Edges = messages. The root? Usually a response to an external-in. Want examples? Go check [tonviewer.com](https://tonviewer.com) — some are [simple](https://tonviewer.com/transaction/6c38b3e3460d6076ae388f6b4ccaaf5cd23587137f171447693d3f5148777513), others [branch out beautifully](https://tonviewer.com/transaction/9804e0cfdfe50987e1d24c7c8ec4c9a2d4361e79e3e949ca36cf8d4aa313d990), and some are just [degenerate one-offs](https://tonviewer.com/transaction/ba9202b8d389def350a56f296812b90e8d0222a49be29a6fdce756ef65e11ed5).<br /> 
...
**Hash** – Anytime you see *"hash"* here, it means the hash of the cell. Don't try to hash the raw bytes like a savage. It won’t work.<br />
...
But it only works if **all of the following** conditions are met:
