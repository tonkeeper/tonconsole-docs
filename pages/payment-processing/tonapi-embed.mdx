...
### Methods **`getJettonTransfers` and `getTonTransfers`**
...
### Methods **`getTonTransfer` and `getJettonTransfer`**

Methods for obtaining a specific ***Transfer*** by ***Transaction*** hash.

### Methods **`getBalance` and `getJettonBalance`**
