...
import { LINKS, GITHUB_LINKS } from "../../constants";
...
The cNFT Indexing Service allows you to add and index your cNFTs via the <ExternalLink href={LINKS.CONSOLE}>Tonconsole</ExternalLink> interface, making them available through TonAPI without requiring immediate on-chain minting.
