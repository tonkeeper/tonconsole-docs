...
2. Enter a TonConnect manifest URL СЮДА НАДО ВСТАВИТЬ ИНФУ ЧТО МАНИФЕСТ ДОЛЖЕН ДОСТУПЕН БЕЗ КОРСОВ (ЖИРНЫМ) or an app URL to register your app. <ExternalLink href={TONORG_LINKS.TONCONNECT_ABOUT}>About TonConnect</ExternalLink>. <ExternalLink href={TONORG_LINKS.TONCONNECT_MANIFEST}>About TonConnect Manifest</ExternalLink>.
3. Click Register.
