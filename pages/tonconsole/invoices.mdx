...
Visit [TON Cconsole](https://tonconsole.com/) and create an account.

### Step 2: Send Project ID

Find your `Project ID` on the [project settings](https://tonconsole.com/settings/edit-project) page and <br/> share it with Rostislav on Telegram: [t.me/tonrostislav](https://t.me/tonrostislav).
